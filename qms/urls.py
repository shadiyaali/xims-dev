...
urlpatterns = [
    ...
    path('replay-message/send/', ReplyMessageCreateAPIView.as_view(), name='send-replay-message'),
    path('forward-message/send/', ForwardMessageCreateAPIView.as_view(), name='send-replay-message'),
